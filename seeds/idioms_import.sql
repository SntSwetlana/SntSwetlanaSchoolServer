-- idioms import generated from PDF
-- source file: engxam.com-CAE-Useful-Idioms-Phrases_-Download-PDF-Sheet1-2.pdf
BEGIN;

INSERT INTO news_posts (kind, title, excerpt, body, source, url, level, image_url, phonetic, is_hot, tags)
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Bird In The Hand Is Worth Two In The Bush'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Blessing In Disguise'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Chip On Your Shoulder'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Dime A Dozen'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Doubting Thomas'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Drop In The Bucket'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Fool And His Money Are Easily Parted'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A House Divided Against Itself Cannot Stand'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Leopard Can’t Change His Spots'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Penny Saved Is A Penny Earned'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Picture Paints A Thousand Words'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Piece Of Cake'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Slap On The Wrist'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Taste Of Your Own Medicine'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('A Toss-Up'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Against The Clock'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('All Bark And No Bite'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('All Greek To Me'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('All In The Same Boat'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('An Arm And A Leg'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('An Axe To Grind'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Apple Of My Eye'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('As High As A Kite'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('At The Drop Of A Hat'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Back Seat Driver'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Back To Square One'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Back To The Drawing Board'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Baker’s Dozen'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Beat A Dead Horse'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Beating Around The Bush'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Bend Over Backwards'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Between A Rock And A Hard Place'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Bite Off More Than You Can Chew'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Bite Your Tongue'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Blood Is Thicker Than Water'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Blue Moon'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Break A Leg'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Buy A Lemon'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Can’t Cut The Mustard'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Cast Iron Stomach'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Charley Horse'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Chew Someone Out'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Chow Down'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Close But No Cigar'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Cock And Bull Story'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Come Hell Or High Water'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Crack Someone Up'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Dark Horse'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Dead Ringer'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Devil’s Advocate'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Dog Days Of Summer'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Don’t Count Your Chickens Before They Hatch'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Don’t Look A Gift Horse In The Mouth'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Don’t Put All Your Eggs In One Basket'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Doozy'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Down To The Wire'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Drastic Times Call For Drastic Measures'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Drink Like A Fish'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Drive Someone Up The Wall'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Dropping Like Flies'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Dry Run'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Eighty Six'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Elvis Has Left The Building'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Every Cloud Has A Silver Lining'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Everything But The Kitchen Sink'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Excuse My French'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Feeding Frenzy'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Field Day'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Finding Your Feet'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Finger Lickin’ Good'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Fixed In Your Ways'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Flash In The Pan'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Flea Market'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Flesh And Blood'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Flip The Bird'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Foam At The Mouth'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Fools’ Gold'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('From Rags To Riches'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Fuddy-Duddy'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Full Monty'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Funny Farm'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Get Down To Brass Tacks'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Get Over It'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Get Up On The Wrong Side Of The Bed'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Get Your Walking Papers'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Give Him The Slip'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Go Down Like A Lead Balloon'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Go For Broke'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Go Out On A Limb'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Go The Extra Mile'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Good Samaritan'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Graveyard Shift'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Great Minds Think Alike'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Gut Feeling'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Haste Makes Waste'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Hat Trick'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('He Lost His Head'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Head Over Heels'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Hell In A Handbasket'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('High Five'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('High On The Hog'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Hit The Books'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Hit The Hay'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Hit The Nail On The Head'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Hit The Sack'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Hold Your Horses'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Icing On The Cake'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Idle Hands Are The Devil’s Tools'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('If It’s Not One Thing, It’s Another'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('In The Bag'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('In The Heat Of The Moment'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('It Takes Two To Tango'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('It’s A Small World'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('It’s Anyone’s Call'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Keep An Eye On Him'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Keep Your Chin Up'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Kick The Bucket'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Knee Jerk Reaction'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Knock On Wood'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Last But Not Least'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Lend Me Your Ear'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Let Bygones Be Bygones'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Let Sleeping Dogs Lie'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Let The Cat Out Of The Bag'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Level Playing Field'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Like A Chicken With Its Head Cut Off'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Loose Cannon'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Make No Bones About It'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Method To My Madness'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Mumbo Jumbo'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Mum’s The Word'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Nest Egg'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Never Bite The Hand That Feeds You'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('New Kid On The Block'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('New York Minute'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('No Dice'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Off On The Wrong Foot'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Off The Hook'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Off The Record'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('On Pins And Needles'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('On The Fence'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('On The Same Page'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Out Of The Blue'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Out On The Town'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Over My Dead Body'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Over The Top'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Pass The Buck'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Pedal To The Metal'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Pig In A Poke'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Pig Out'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Pipe Down'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Practice Makes Perfect'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Pull The Plug'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Pulling Your Leg'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Put A Sock In It'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Raincheck'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Raining Cats And Dogs'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Rise And Shine'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Rome Was Not Built In One Day'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Rule Of Thumb'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Run Out Of Steam'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Smell A Rat'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Smell Something Fishy'));
...
WHERE NOT EXISTS (SELECT 1 FROM news_posts WHERE lower(title) = lower('Start From Scratch'));
